...
//use for SQL commands CREATE, DROP, INSERT and UPDATE
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            db.update(
                "CREATE TABLE user_table ( id BIGINT IDENTITY, username VARCHAR(256), password VARCHAR(256) )");
        ...
        try {
        	...
        	db.update("DELETE FROM user_table");
        	
            // add some rows - will create duplicates if run more then once
            // the id column is automatically generated
            db.update("INSERT INTO user_table(username,password) VALUES('tim', 'tim')");
            db.update("INSERT INTO user_table(username,password) VALUES('steve', 'steve')");
            db.update("INSERT INTO user_table(username,password) VALUES('reggie', 'reggie')");
            db.update("INSERT INTO user_table(username,password) VALUES('bill', 'bill')");
            // do a query
